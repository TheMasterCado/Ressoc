  ...
  <form id="formulaire" class="" action="./mc_creerCompte.php" method="post">
    <table>
      <tr>
        ...
        <td><input class="form-control" type="text" name="prenom" value="<?=$_SESSION['newUser']['prenom']?>" required></td>
      </tr>
      <tr>
        <td><label for="nom">Nom :</label></td>
        <td><input class="form-control" type="text" name="nom" value="<?=isset($_SESSION['newUser']['nom']) ? $_SESSION['newUser']['nom'] : ""?>" required></td>
      </tr>
      <tr>
        <td><label for="nbSessions">Nombre de sessions en informatique :</label></td>
        <td><input class="form-control" type="number" name="nbSessions" min="1" max="6" required></td>
      </tr>
      <tr>
        <td><label for="specialite">Spécialité (facultatif) :</label></td>
        <td><input class="form-control" type="text" name="specialite"></td>
      </tr>
